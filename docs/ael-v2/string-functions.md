...
> **AEL v2** — [cheat-sheet.md](cheat-sheet.md) · [DECISIONS.md](DECISIONS.md) · [SOURCES.md](SOURCES.md). Regex `=~`: [operators-and-precedence.md](operators-and-precedence.md). **Last reviewed:** 2026-05-20.

The Aerospike server adds a comprehensive string operations API (SERVER-97). String
...
| Path modifiers | Path suffix on the read | **`$.m.key:INT`**, **`$.l.[0]:INT`** — type the value at that navigation point ([path-and-selectors.md](path-and-selectors.md)) |
