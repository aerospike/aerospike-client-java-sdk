...
/**
 * Indicates that no applicable {@link Filter} could be generated for a given AEL expression. For internal use.
 *
 * <p>This exception is typically thrown when attempting to create a Filter for a AEL expression
