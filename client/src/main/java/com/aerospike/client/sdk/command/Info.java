...
public class Info {
	 ...
	 * @param command		command sent to server
	 */
	public Info(Node node, Connection conn, String command) {
		int size = Buffer.estimateSizeUtf8Quick(command) + 9;
	 ...
	 * @param commands		commands sent to server
	 */
	public Info(Node node, Connection conn, String... commands) {
		int size = 8;
	...
	public HashMap<String,String> parseMultiResponse() {
