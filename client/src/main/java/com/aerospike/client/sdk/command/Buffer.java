...
public final class Buffer {
    ...
    /*
    private static Object parseList(byte[] buf, int offset, int len) throws AeroException {
    ...
    private static Object parseMap(byte[] buf, int offset, int len) throws AeroException {
        Object key;
        Object value;
