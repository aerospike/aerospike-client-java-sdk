...
public final class Key {
	 ...
	 */
	public Key(String namespace, String setName, String key) {
	 ...
	 * @throws AerospikeException	if digest computation fails
	 */
	public Key(String namespace, String setName, byte[] key, int offset, int length) {
		this.namespace = namespace;
		this.setName = setName;
	 ...
	 * @throws AerospikeException	if digest computation fails
	 */
	public Key(String namespace, String setName, int key) {
		this.namespace = namespace;
		this.setName = setName;
	 ...
	 * @throws AerospikeException	if digest computation fails
	 */
	public Key(String namespace, String setName, long key) {
		this.namespace = namespace;
		this.setName = setName;
		this.userKey = new Value.LongValue(key);
		digest = Crypto.computeDigest(setName, this.userKey);
	 ...
	 * @throws AerospikeException	if digest computation fails
	 */
	public Key(String namespace, String setName, Value key) {
		this.namespace = namespace;
		this.setName = setName;
		this.userKey = key;
	 ...
	 *
	public Key(String namespace, String setName, Object key) {
		this.namespace = namespace;
		this.setName = setName;
		this.userKey = key;
