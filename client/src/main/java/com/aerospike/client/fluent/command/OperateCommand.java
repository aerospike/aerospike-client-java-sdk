...
public class OperateCommand extends WriteCommand {
	...
	public OperateCommand(
		...
		ReadModeAP readModeAP, ReadModeSC readModeSC, Expression filterExp,
		boolean failOnFilteredOut, SettableWritePolicy policy
	) {
		super(cluster, txn, key, type, gen, ttl, filterExp, failOnFilteredOut, policy);
