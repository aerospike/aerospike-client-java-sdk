 ...
 * the License.
 */
package com.aerospike.client.fluent.configuration.serializers.dynamicconfig;

import java.util.List;

import com.aerospike.client.fluent.Log;
import com.aerospike.client.fluent.configuration.primitiveprops.BooleanProperty;
import com.aerospike.client.fluent.configuration.primitiveprops.IntProperty;
import com.aerospike.client.fluent.configuration.primitiveprops.StringProperty;
