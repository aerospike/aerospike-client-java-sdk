...
public class LogicalParsedExpressionTests {
    ...
    void binLogical_AND_all_indexes() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin1").indexType(IndexType.INTEGER)
                        .binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER)
    ...
    void binLogical_AND_all_indexes_no_cardinality() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
    ...
    void binLogical_AND_AND_all_indexes() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
        Filter filter = Filter.range("intBin2", 101, Long.MAX_VALUE);
        Exp exp = Exp.and(
                Exp.gt(Exp.intBin("intBin1"), Exp.val(100)),
    ...
    void binLogical_AND_AND_all_indexes_same_cardinality() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(100).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(100).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(100).build()
        );
    ...
    void binLogical_AND_AND_all_indexes_partial_data() {
        List<Index> indexes = List.of(
                Index.builder().namespace("other_ns").bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace("other_ns").bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
    ...
    void binLogical_AND_AND_explicitly_given_index_unavailable() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin2").bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
    ...
    void binLogical_AND_AND_explicitly_given_index_namespace_mismatch() {
        List<Index> indexes = List.of(
                Index.builder().namespace("other_namespace").name("idx_bin1").bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin2").bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build()
        );
    ...
    void binLogical_AND_AND_explicitly_given_index_null() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin1").bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin2").bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin3").bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
    ...
    void binLogical_AND_AND_explicitly_given_index_overrides_alphabetical() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin1").bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(100).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin2").bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(100).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin3").bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(100).build()
        );
    ...
    void binLogical_AND_AND_with_OR_subexpression_explicitly_given_index() {
        List<Index> indexes = List.of(
                ...
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin2").bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin3").bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin4").bin("intBin4").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
    ...
    void binLogical_OR_OR_all_indexes_same_cardinality() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(1).build()
        );
        Filter filter = null;
        Exp exp = Exp.or(
                Exp.gt(Exp.intBin("intBin1"), Exp.val(100)),
    ...
    void binLogical_OR_OR_provided_index_no_filter_created() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin1").bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin2").bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_bin3").bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
    ...
    void binLogical_prioritizedAND_OR_prioritizedAND_indexed() {
        List<Index> indexes = List.of(
                ...
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin4").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
        Filter filter = null;
        Exp exp = Exp.or(
                Exp.and(
    ...
    void binLogical_prioritizedAND_OR_prioritizedAND_indexed_same_cardinality() {
        List<Index> indexes = List.of(
                ...
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(1).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin4").indexType(IndexType.INTEGER).binValuesRatio(1).build()
        );
        Filter filter = null;
        Exp exp = Exp.or(
                Exp.and(
    ...
    void binLogical_OR2_OR1_AND2_AND_AND1_indexed_no_cardinality() {
        List<Index> indexes = List.of(
                ...
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin3").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin4").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin5").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin6").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
        Filter filter = Filter.range("intBin1", 101, Long.MAX_VALUE);
        Exp exp = Exp.and(
                Exp.or(
    ...
    void binLogical_OR2_OR1_AND2_AND_AND2_OR1_AND2_indexed_no_cardinality() {
        List<Index> indexes = List.of(
                ...
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin5").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin6").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin7").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin8").indexType(IndexType.INTEGER).binValuesRatio(0).build()
        );
    ...
    void binLogical_AND_AND_bin_hint_namespace_mismatch_falls_back_to_automatic() {
        List<Index> indexes = List.of(
                Index.builder().namespace("other_namespace").bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(0).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin2").indexType(IndexType.INTEGER).binValuesRatio(1).build()
        );
    ...
    void binLogical_AND_AND_bin_hint_multiple_indexes_same_bin_falls_back_to_automatic() {
        List<Index> indexes = List.of(
                Index.builder().namespace(TestUtils.NAMESPACE).bin("intBin1").indexType(IndexType.INTEGER).binValuesRatio(5).build(),
    ...
    void withBinHint_mixedTypes_stringQuerySelectsString() {
        List<Index> indexes = List.of(
                ...
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_status_num").bin("status")
                        .indexType(IndexType.INTEGER).binValuesRatio(3).build()
        );
    ...
    void withBinHint_andWithOrSubexpr_fallsBack() {
        List<Index> indexes = List.of(
                ...
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_intBin3_num").bin("intBin3")
                        .indexType(IndexType.INTEGER).binValuesRatio(30).build(),
                Index.builder().namespace(TestUtils.NAMESPACE).name("idx_intBin4_num").bin("intBin4")
                        .indexType(IndexType.INTEGER).binValuesRatio(20).build()
        );
        Filter filter = Filter.range("intBin2", 101, Long.MAX_VALUE);
        Exp exp = Exp.and(
                Exp.gt(Exp.intBin("intBin1"), Exp.val(100)),
