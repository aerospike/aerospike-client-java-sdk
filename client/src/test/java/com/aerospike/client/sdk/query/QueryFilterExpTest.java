...
public class QueryFilterExpTest extends ClusterTest {
    ...
    public void queryList1() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.gt(ListExp.getByValue(ListReturnType.COUNT, Exp.val(4), Exp.listBin("listbin")),
                Exp.val(0)));
    ...
    public void queryList2() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.eq(ListExp.getByValue(ListReturnType.COUNT, Exp.val(5), Exp.listBin("listbin")),
                Exp.val(0)));
    ...
    public void queryList3() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.eq(ListExp.getByIndex(ListReturnType.VALUE, Exp.Type.INT, Exp.val(4),
                Exp.listBin("listbin")), Exp.val(20)));
    ...
    public void queryMap1() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.gt(MapExp.getByKey(MapReturnType.COUNT, Exp.Type.INT, Exp.val("B"), Exp.mapBin(
                "mapbin")), Exp.val(0)));
    ...
    public void queryMap3() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.eq(MapExp.getByKey(MapReturnType.COUNT, Exp.Type.INT, Exp.val("D"),
                Exp.mapBin("mapbin")), Exp.val(0)));
    ...
    public void queryMap4() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.eq(MapExp.getByValue(MapReturnType.COUNT, Exp.val("AAA"), Exp.mapBin("mapbin")),
                Exp.val(0)));
    ...
    public void queryMap5() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.eq(MapExp.size(MapExp.getByKeyList(MapReturnType.KEY_VALUE, Exp.val(list),
                Exp.mapBin("mapbin"))), Exp.val(2)));
    ...
    public void queryMap6() {
        ...
        Exp filterExp = Exp.and(
            Exp.ge(Exp.intBin(binName), Exp.val(begin)),
            Exp.le(Exp.intBin(binName), Exp.val(end)),
            Exp.eq(ListExp.size(MapExp.getByKeyList(MapReturnType.VALUE, Exp.val(list),
                Exp.mapBin("mapbin"))), Exp.val(2)));
