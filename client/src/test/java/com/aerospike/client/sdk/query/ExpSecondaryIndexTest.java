...
public class ExpSecondaryIndexTest extends ClusterTest {
    ...
    public static void setup() {
        ...
        Assumptions.assumeTrue(condition,
            "SI Expression tests skipped because the server does not support this feature");
    }
    ...
    public static void addExpSI() {
        try {
            session.createIndex(dataSet, indexName, IndexType.INTEGER, IndexCollectionType.DEFAULT,
                exp)
                .waitTillComplete();
        }
