...
public class Args {
    ...
    public Args() {
        ...
        try {
            ...
            options.addOption("s", "set", true,
                "Set name. Use 'empty' for empty set (default: test)");
            options.addOption("auth", true,
                "Authentication mode. Values: " + Arrays.toString(AuthMode.values()));
    ...
    public void setServerSpecific(Cluster cluster) {
        ...
        String editionFilter =
            serverVersion.isGreaterOrEqual(Version.SERVER_VERSION_8_1) ? "release" : "edition";
