...
public class QueryGeoTest extends ClusterTest {
    private static final DataSet set = DataSet.of(args.set.getNamespace(), "geo");
    private static final DataSet setPoints = DataSet.of(args.set.getNamespace(), "geopt");
    private static final DataSet setRegions = DataSet.of(args.set.getNamespace(), "georeg");
    ...
    public static void prepare() {
        try {
            session.createIndex(set, indexName, binName, IndexType.GEO2DSPHERE,
    ...
    public static void destroy() {
        session.dropIndex(set, indexName);
    }
